<?php 
$connect = mysqli_connect("localhost", "root", "", "ternz"); 
session_start(); 
...
{ 
		...
		{
			return true; $_SESSION["username"] = $username; header("location:entry.php"); 
		}
		else 
		{ 
			return false; echo '<script>alert("Wrong User Details")</script>'; 
		} 
	} 
} 
else 
...
?>
 ...
 <?php if(isset($_GET["action"]) == "login") {
	 ...
	 <br /> <p align="center"><a href="index.php">Register</a></p> 
	 </form>
	 <?php }
	 else { 
	 ?> 
	 <h3 align="center">Register</h3> <br />
	 <form method="post"> <label>Enter Username</label>
	 <input type="text" name="username" class="form-control" /> 
	 <br /> <label>Enter Password</label>
	 <input type="text" name="password" class="form-control" /> <br />
	 <input type="submit" name="register" value="Register" class="btn btn-info" /> <br /> 
	 <p align="center"><a href="index.php?action=login">Login</a></p> </form> <?php } ?> 
	 </div> 
	 </body> 
	 </html> 